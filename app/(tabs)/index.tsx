...
const styles = StyleSheet.create({
  ...
  dateText: { color: '#fff', fontSize: 16, opacity: 0.85 },
  progressText: { color: '#fff', fontSize: 22, fontWeight: 'bold' },
  ...
  hintText: { color: '#fff', fontSize: 14, opacity: 0.7, marginTop: 2 },
  ...
  errorRetry: { color: '#DC2626', fontSize: 15, marginTop: 4 },
  centerBox: { paddingVertical: 48, alignItems: 'center' },
  emptyText: { color: '#6B7280', fontSize: 16, textAlign: 'center', lineHeight: 24 },
  taskItem: {
  ...
  taskTime: { width: 54, fontSize: 16, fontVariant: ['tabular-nums'], color: '#6B7280', fontWeight: '600' },
  taskCheck: {
  ...
  checkmark: { color: '#fff', fontSize: 19, fontWeight: 'bold' },
  taskContent: { flex: 1 },
  taskTitle: { fontSize: 17, fontWeight: '600', color: '#111827' },
  taskTitleDone: { textDecorationLine: 'line-through', color: '#6B7280' },
  taskMeta: { fontSize: 15, color: '#9CA3AF', marginTop: 2 },
  footNote: { fontSize: 14, color: '#9CA3AF', lineHeight: 20, marginTop: 8, marginBottom: 24 },
});
