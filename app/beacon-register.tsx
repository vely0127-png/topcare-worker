...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, fontSize: 16, marginTop: 10 },
  label: { fontSize: 16, fontWeight: '700', color: '#0f172a', marginTop: 16, marginBottom: 8 },
  ...
  roomChipText: { fontSize: 16, color: '#334155' },
  ...
  hint: { fontSize: 15, color: '#94a3b8', marginTop: 8 },
  ...
  beaconId: { fontSize: 16, fontWeight: '600', color: '#0f172a' },
  beaconMeta: { fontSize: 15, color: '#64748b', marginTop: 2 },
  inactive: { fontSize: 14, color: '#9CA3AF' },
  deniedTitle: { fontSize: 18, fontWeight: '700', color: '#334155', marginTop: 12 },
  deniedText: { fontSize: 16, color: '#64748b', marginTop: 6, textAlign: 'center' },
  ...
  scanCloseText: { fontSize: 17, fontWeight: '700', color: '#0f172a' },
});
